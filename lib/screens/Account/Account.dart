...
import 'package:Imperium/request/RequestLogin.dart';
import 'package:flutter/material.dart';
import 'package:Imperium/request/Json/Matter/JsonMatterSearch.dart';
    ...
    return Scaffold(
        ...
        body: ListView(children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 45.0),
            child: TextField(
              controller: _textFieldControllerMatricula,
              decoration: InputDecoration(
                hintText: "Matrícula",
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.0),
