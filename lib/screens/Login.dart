    ...
    return Scaffold(
        bottomNavigationBar: BottomAppBar(
          ...
          child: Row(
            ...
            children: <Widget>[
              IconButton(icon: Image(image: NetworkImage('https://www.facebook.com/images/fb_icon_325x325.png',) ), onPressed: () {
                _launchURL('https://www.facebook.com/imperiumconcursos/');
              },),
              IconButton(icon: Image(image: NetworkImage('https://i2.wp.com/alufemaesquadrias.com.br/wp-content/uploads/2018/05/WhatsApp-icon.png?fit=256%2C256'), ), onPressed: () {
                _launchURL('https://api.whatsapp.com/send?phone=+5502199900-5045');
              },),
              IconButton(icon: Image(image: NetworkImage('https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Instagram-Icon.png/220px-Instagram-Icon.png'), ), onPressed: () {
                _launchURL('https://www.instagram.com/imperiumconcursos/');
              },),
            ],
          ),
        ),
